...
const Hotel_Rooms_Premier = () => {
    const room = hotel_rooms.find(room => room.id === 3);

    // State to manage the current large image and selected thumbnail index
    const [currentImage, setCurrentImage] = useState('/img/hotel_rooms/hotel_rooms_003.webp');
    ...
    return (
            <div className="hotel_rooms_premier">
...
export default Hotel_Rooms_Premier